...
class Tournament(models.Model):
    ...
    cup = models.ForeignKey(Cup, null=True)
...
class Participation(models.Model):
    partaker = models.ForeignKey(Partaker, null=True)
...
class Duel(models.Model):
    tournament = models.ForeignKey(Tournament)
    player1 = models.ForeignKey(Participation, related_name='game_played')
    player2 = models.ForeignKey(Participation, related_name='game_played2')
...
class PlayerCache(models.Model):
    partaker = models.ForeignKey(Partaker, default=None)
